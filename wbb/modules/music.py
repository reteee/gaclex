...
from wbb.utils.pluginhelper import get_text, progress
from wbb import pbot, arq

__MODULE__ = "Music"
__HELP__ = """
/play (judul lagu) Untuk memulai suatu musik. [SUDOERS]
/pause Untuk pause musik.
/skip Untuk melewati lagu yang diputar.
